...
REM  Ket qua: file XPathScanner.App.exe trong thu muc "publish"
...
REM   - Chi can copy 1 file XPathScanner.App.exe sang may khac
REM ============================================================
...
echo.
echo [2/2] THANH CONG!
echo   File exe:  %OUT%\XPathScanner.App.exe
echo.
echo GHI CHU:
